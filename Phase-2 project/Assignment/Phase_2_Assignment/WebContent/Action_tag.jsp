...
<jsp:useBean id="productBean" class="com.jsp.ProductBean" scope="session"></jsp:useBean>
...
<a href="Action_showbean.jsp">Access bean properties from another page</a><br>
<a href="Actiontag_forward.jsp">Use Forward action to go to Google</a><br>
